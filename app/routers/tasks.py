...
async def add_image_to_task(
    ...
    # Добавляем задачу для фоновой обработки изображения
    background_tasks.add_task(process_image_task, task, image, task_crud, persons_crud, images_crud, file_bytes, file_name)
